...
- MUST validate standard claims appropriate to your system (at least `exp`; typically also `iss`/`aud` if multi-service or multi-organization).
...
- Add object-level checks (ownership, ACLs, organization boundaries).
